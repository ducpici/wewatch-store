        ...
        <Routes>
          <Route element={<PrivateRoute />}>
            ...
            <Route element={<AppLayout />}>
              ...
              <Route path="/positions/add-new" element={<AddPosition />} />
              ...
              <Route path="/functions/add-new" element={<AddFunction />} />
              ...
              <Route path="/vouchers/add-new" element={<AddVoucher />} />
              <Route path="/vouchers/edit/:id" element={<EditVoucher />} />

              {/* Banners */}
              <Route path="/banners" element={<Banners />} />
              <Route path="/banners/add-new" element={<AddBanner />} />
