...
class Footer extends React.Component {
  render() {
    return (
      <footer className="footer grid auto-rows-auto md:grid-cols-4 pt-4 space-y-2">
        <div className="footer-block">
          <div className="flex justify-center">
            <Link to="/" className="py-1">
              <img className="w-20" src="/images/mylogo.png" alt="" />
            </Link>
          </div>
          <ul className="list-contact">
            <li>
              ...
              <span>
                Số 123 Đường Trường Chinh, Phường Vị Hoàng, Thành phố Nam Định
              </span>
            </li>
            <li>
              <svg
        ...
        <div className="footer-block">
          ...
          <ul className="nav-menu">
            ...
            <li>
              <Link to="/danh-muc/dong-ho-cap-doi">Đồng hồ Cặp đôi</Link>
            </li>
          </ul>
        </div>
        <div className="footer-block">
