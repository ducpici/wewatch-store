...
const AboutPage = () => {
  ...
  return (
    <div className="container px-2 md:max-w-6xl m-auto mb-5 md:mb-10">
      ...
      <div className="relative bg-gradient-to-r from-slate-900 via-slate-800 to-slate-900 text-white py-20 px-6">
        ...
        <div className="relative max-w-6xl mx-auto text-center">
          ...
          <p className="text-xl text-slate-300 max-w-3xl mx-auto leading-relaxed">
            Chào mừng bạn đến với cửa hàng đồng hồ uy tín, nơi thời gian không
            chỉ đơn thuần là con số mà còn là sự thể hiện phong cách và đẳng cấp
            cá nhân
          </p>
        </div>
      </div>
          ...
          <div className="grid md:grid-cols-2 gap-12 items-center">
            <div className="space-y-6">
              <p className="text-lg text-slate-600 leading-relaxed">
                Sứ mệnh của chúng tôi là mang đến cho bạn trải nghiệm mua sắm
                trực tuyến tuyệt vời với những chiếc đồng hồ cao cấp. Với kho bộ
                sưu tập phong phú, từ những thương hiệu nổi tiếng thế giới đến
                những dòng sản phẩm độc quyền.
              </p>
              <p className="text-lg text-slate-600 leading-relaxed">
                Chúng tôi luôn cập nhật xu hướng mới nhất để đáp ứng nhu cầu của
                mọi khách hàng. Đội ngũ thiết kế của chúng tôi làm việc không
                ngừng nghỉ để tạo ra những sản phẩm không chỉ đẹp mắt mà còn
                thoải mái và dễ đeo.
              </p>
            </div>
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6 lg:gap-8">
            {[
              ...
              },
              {
                ...
                description: "Bảo hành chính hãng và hỗ trợ khách hàng 24/7",
              },
            ].map((item, index) => (
        ...
        <div className="mb-20">
          <div className="bg-gradient-to-r from-slate-800 to-slate-900 rounded-3xl p-8 md:p-12 text-white">
            <div className="text-center mb-10">
              <h2 className="text-4xl font-bold mb-4">Cam Kết Chất Lượng</h2>
              <p className="text-slate-300 text-lg max-w-2xl mx-auto">
                Chúng tôi hiểu rằng việc mua đồng hồ trực tuyến đòi hỏi sự tin
                tưởng. Vì vậy, chúng tôi cam kết:
              </p>
            </div>
            <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6">
              {[
                ...
                <div key={index} className="text-center">
                  ...
                  <h4 className="font-semibold text-lg">{commitment}</h4>
                </div>
              ))}
            </div>
          </div>
        ...
        <div className="mb-20">
          <div className="grid md:grid-cols-2 gap-12 items-center">
            <div className="space-y-6">
              ...
              <p className="text-lg text-slate-600 leading-relaxed">
                Được thành lập với niềm đam mê dành cho nghệ thuật chế tác đồng
                hồ, chúng tôi đã không ngừng phát triển và hoàn thiện để trở
                thành một trong những địa chỉ tin cậy hàng đầu trong lĩnh vực
                bán lẻ đồng hồ.
              </p>
              <p className="text-lg text-slate-600 leading-relaxed">
                Từ một cửa hàng nhỏ, chúng tôi đã mở rộng thành một hệ thống bán
                lẻ trực tuyến với hàng ngàn khách hàng tin tưởng.
              </p>
            </div>
            <div className="relative">
        ...
        <div className="bg-gradient-to-r from-amber-50 to-orange-50 rounded-3xl p-8 md:p-12">
          <div className="text-center mb-10">
            ...
            <p className="text-slate-600 text-lg">
              Cảm ơn bạn đã tin tưởng và lựa chọn chúng tôi. Chúng tôi cam kết
              sẽ luôn đồng hành cùng bạn trong hành trình tìm kiếm chiếc đồng hồ
              hoàn hảo!
            </p>
          </div>
          <div className="grid md:grid-cols-3 gap-8">
            ...
            <div className="text-center group">
              ...
              <p className="text-slate-600">wewatch.contact@gmail.com</p>
            </div>
            <div className="text-center group">
              <div className="w-16 h-16 bg-gradient-to-r from-amber-400 to-orange-500 rounded-full flex items-center justify-center mx-auto mb-4 group-hover:scale-110 transition-transform duration-300">
              ...
              <p className="text-slate-600">
                123 Đường Trường Chinh, Phường Vị Hoàng, Thành phố Nam Định
              </p>
            </div>
          </div>
        </div>
