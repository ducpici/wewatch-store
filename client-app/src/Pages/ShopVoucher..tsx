...
export default function ShopVoucher() {
  ...
  const fetchAllVouchers = async (page: number, limit: number) => {
    setLoading(true);
    try {
      const res = await axios.get(`/vouchers?page=${page}&limit=${limit}`);
                  ...
                  <div className="flex-1 min-w-0">
                    ...
                    <div className="space-y-1 text-xs text-gray-600">
                      <div className="flex items-center">
                        <span className="text-gray-500 mr-2">Mã voucher:</span>
                      ...
                      <div className="flex items-center">
                        <span className="text-gray-500 mr-2">Giá trị:</span>
                        <span className="font-medium text-red-600">
                          {voucher.discount_type.code === 1
