          ...
          <div className="flex flex-col lg:flex-row">
            ...
            <div className="bg-gradient-to-br from-gray-50 to-gray-100 p-8 lg:w-1/2">
              ...
              <p className="text-gray-600 mb-8">
                Bạn cũng có thể liên hệ với chúng tôi thông qua địa chỉ bên
                dưới!
              </p>
              ...
              <div className="space-y-6">
                ...
                <div className="flex items-center space-x-4">
                  ...
                  <div>
                    <p className="text-gray-800 font-semibold">0350395372</p>
                  </div>
                </div>
                ...
                <div className="flex items-center space-x-4">
                  ...
                  <div>
                    <p className="text-gray-800 font-semibold">Thứ 2 - Thứ 6</p>
