...
const Cart = () => {
  ...
  const handleCheckout = async () => {
    if (!user?.email) {
      toast.warning("Vui lòng cập nhật thông tin cá nhân trước khi mua hàng");
      ...
      {loading ? (
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          ...
          <div className="border border-gray-200 rounded p-6">
            <h2 className="text-lg font-semibold mb-4">CỘNG GIỎ HÀNG</h2>
            ...
            <div className="flex justify-between font-bold text-lg mb-4">
              <span>Tổng</span>
              <span>{(newTotal || subtotal).toLocaleString()} ₫</span>
            </div>
            <button
