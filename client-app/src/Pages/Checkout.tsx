  ...
  return (
    <div className="max-w-md mx-auto px-2">
      ...
      <div className="mb-3">
        ...
        <ul className="space-y-2">
          {items.map((item: any) => (
            <li
              key={item.id}
              className="flex p-2 border-gray-200 border rounded"
            >
              <img src={`${BASE_URL}${item.image}`} className="w-16 h-16" />

              <div className="product-detail pl-2">
                <p className="text-justify line-clamp-2">{item.name}</p>
      ...
      <div className="mb-3">
        ...
        <div className="flex cursor-pointer" onClick={handleClickAddress}>
          ...
          <div className="flex justify-between w-full px-2">
            {address ? (
              ...
              <p className="text-red-500 text-sm whitespace-nowrap px-2">
                Bạn chưa có địa chỉ nhận hàng. Bấm để chọn hoặc thêm mới.
              </p>
            )}
          </div>
          <div className="flex items-center">
