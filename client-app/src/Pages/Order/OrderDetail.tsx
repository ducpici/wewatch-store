...
export default function OrderDetail() {
        ...
        return (
          <>
            ...
            <div>
              ...
              <p className="text-sm text-yellow-500">Hãy chuẩn bị nhận hàng!</p>
            </div>
          </>
        );
      case 3:
        return (
          <>
            ...
            <div>
              ...
              <p className="text-sm text-green-500">Cảm ơn bạn đã mua hàng!</p>
            </div>
          </>
        );
      case 4:
      ...
      case 5:
        return (
          <>
            ...
            <div>
              <h3 className="font-semibold text-red-500">Đơn hàng đã bị hủy</h3>
  ...
  return (
    <div className="container md:max-w-6xl m-auto px-2">
      ...
      <div className="max-w-6xl mx-auto md:p-6 min-h-screen space-y-3">
        {/* Header Alert */}
        <div className="bg-white rounded border border-gray-200 p-2 md:p-4 flex items-center justify-between">
          <div className="flex items-center space-x-3">
            {typeof dataOrderDetail?.order_state.code === "number" &&
              renderStateMessage(dataOrderDetail.order_state.code)}
          </div>
          {dataOrderDetail?.order_state.code == 0 ? (
            <button
              ...
              onClick={() => handleCancelOrder(dataOrderDetail?.id)}
            >
              Hủy đơn
            </button>
          ) : (
        ...
        {/* Order Info */}
        <div className="bg-white rounded border border-gray-200 p-2 md:p-4 space-y-2">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-2">
            ...
            <div className="flex items-center space-x-3">
              ...
              <div>
                ...
                <p className="font-semibold text-gray-800">
                  {formatDateToVietnamese(dataOrderDetail?.created_at)}
                </p>
              </div>
            </div>
          </div>
          ...
          {/* Customer Info */}
          <div>
            <h4 className="font-semibold text-gray-600 flex items-center mb-2">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              <div className="space-y-2">
                <div>
                  ...
                  <p className="font-semibold text-gray-800">
                    {dataOrderDetail?.shipping_address?.full_name}
                  </p>
                </div>
                <div>
                  <p className="text-sm text-gray-600">Số điện thoại:</p>
                  <p className="text-gray-800 font-semibold">
                    {dataOrderDetail?.shipping_address.phone_num}
                  </p>
                </div>
                <div>
                  ...
                  <p className="text-gray-800 font-semibold">
                    ...
                    {dataOrderDetail?.shipping_address?.district},{" "}
        ...
        {/* Products */}
        <div className="bg-white rounded border border-gray-200 p-2 md:p-4">
          ...
          <div className="cardDesktop hidden md:block">
            ...
            <div className="bg-green-600 text-white px-4 py-3 border-t rounded">
              ...
              >
                <div className="flex items-center gap-3">
                  <img
                    src={`${BASE_URL}${item.image}`}
                    alt="Product"
                    className="w-16 h-16 object-cover rounded bg-gray-100 cursor-pointer"
                    onClick={() => navigate(`/san-pham/${item.slug}`)}
                  />
                  <p className="font-medium text-gray-700">{item.name}</p>
                </div>
        ...
        <div className="bg-gray-50 p-4 rounded-b-lg mt-2">
          <h5 className="font-semibold text-gray-800 mb-4">Thanh toán</h5>
          <div className="space-y-3">
            ...
            <p className="text-sm text-gray-500">(Đã bao gồm VAT & Giảm giá)</p>
          </div>
        </div>
      </div>
    </div>
