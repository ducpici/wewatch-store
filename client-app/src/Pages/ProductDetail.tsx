...
import RelatedProduct from "@/components/common/RelatedProductList";
...
export default function ProductDetail() {
  ...
  return (
    <div className="container md:max-w-6xl m-auto px-2">
            ...
            <table className="mt-4 w[800px] text-sm text-left whitespace-nowrap">
              <tbody>
                ...
                <tr className="">
                  ...
                  <td className="p-2">{product.crystal_material}</td>
                </tr>
                <tr className="">
                  <td className="p-2">Máy:</td>
                  <td className="p-2">{product.movement_type}</td>
                </tr>
                <tr className="">
                  <td className="p-2">Đường kính mặt số:</td>
                  <td className="p-2">{product.dial_diameter}</td>
                </tr>
                <tr className="">
                  <td className="p-2">Bề dày thân:</td>
                  <td className="p-2">{product.case_thickness}</td>
                </tr>
                <tr className="">
                  <td className="p-2">Chất liệu dây đeo:</td>
                  <td className="p-2">{product.strap_material}</td>
                </tr>
                <tr className="">
                  <td className="p-2">Khả năng chịu nước</td>
                  <td className="p-2">{product.water_resistance} ATM</td>
                </tr>
                <tr className="">
                  <td className="p-2">Chức năng:</td>
                  <td className="p-2">
                    {product?.functions?.map((item) => item.name).join(", ")}
                  </td>
                </tr>
              </tbody>
            </table>
      ...
      <RelatedProduct title="Sản phẩm liên quan" slug={product.brand.slug} />
    </div>
  );
}
